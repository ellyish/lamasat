...
suffix="_unhinted";var fonts=[{"fontFamily":"Kuro-Regular","url":wfpath+"262B22_0"+suffix+"_0."+webfontType}];var len=fonts.length;document.write("<style>");for(var i=0;i<len;i++){if(webfontType=="svg#wf"){var format="svg";}
